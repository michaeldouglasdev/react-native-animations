...
import { BottomBarActiveBackground, BottomBarContainer, BottomBarContent } from './bottom-bar.styles';
...
export const BottomBar: React.FC<BottomTabBarProps> = ({
  ...
  return (
    <BottomBarContainer style={{ paddingBottom: bottom }}>
      <BottomBarActiveBackground
        width={110}
        height={60}
        viewBox="0 0 110 60"
