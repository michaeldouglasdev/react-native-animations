...
import { LiquidSwipeWaveContainer } from "./liquid-swipe-wave.styles";
...
interface LiquidSwipeWaveProps {
  side: Side;
  children: ReactNode;
...
export const LiquidSwipeWave = ({ side, children, position, isTransitioning }: LiquidSwipeWaveProps) => {
  ...
  const animatedProps = useAnimatedProps(() => {
    ...
    // control points to curve = Points 1 and Control 1
  ...
  return (
    <LiquidSwipeWaveContainer maskElement={(
      <Svg style={[
