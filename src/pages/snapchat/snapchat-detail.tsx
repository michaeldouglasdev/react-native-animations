...
import { Dimensions, Image, PanResponder } from 'react-native';
...
import { SnapchatDetailContainer, SnapchatDetailImage } from './snapchat-detail.styles';
    ...
    <PanGestureHandler onGestureEvent={onGestureEvent}>
      <SnapchatDetailContainer>
        <SharedElement id={story.id} style={{flex: 1}}>
            <SnapchatDetailImage source={story.thumb} style={[style, borderStyle, {alignSelf: 'flex-start'}]}/>
        </SharedElement>
      </SnapchatDetailContainer>
    </PanGestureHandler>
  )
